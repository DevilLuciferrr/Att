...
class Train:
    def __init__(self,root):
        ...
        title_lbl = Label(self.root, text="TRAIN DATA SET",font=("Imprint MT Shadow", 35, "bold"), bg="white", fg="darkgreen")
        ...
        #Button
        b1_1 = Button(self.root, text="TRAIN DATA", cursor="hand2", command=self.train_classifier,font=("Imprint MT Shadow", 30, "bold"),bg="darkred", fg="white")
