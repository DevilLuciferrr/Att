...
class Help:
    def __init__(self,root):
        ...
        title_lb3 = Label(main_frame, text="aayush.agrawal.ug20@nsut.ac.in",font=("times new roman", 18, "bold"), bg="white", fg="#FF5733")
        title_lb3.place(x=20, y=60,height=40) 
        
        title_lb4 = Label(main_frame, text="prashant.yadav.ug20@nsut.ac.in",font=("times new roman", 18, "bold"), bg="white", fg="#FF5733")
        title_lb4.place(x=20, y=110,height=40) 
        
        title_lb5 = Label(main_frame, text="tarun.tanwar.ug20@nsut.ac.in",font=("times new roman", 18, "bold"), bg="white", fg="#FF5733")
